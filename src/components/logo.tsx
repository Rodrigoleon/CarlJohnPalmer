...
export function Logo({ className, fill = 'currentColor', title }: LogoProps) {
  return (
    <svg
    ...
    >
      ...
      <g transform="translate(-371.548 -248)">
        ...
        <circle cx="13" cy="13" r="13" transform="translate(509 248)" fill={fill} />
        <circle cx="13" cy="13" r="13" transform="translate(401 248)" fill={fill} />
      </g>
    </svg>
  )
}
